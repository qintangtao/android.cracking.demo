    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        while (true)
        {
          ...
          break label170;
          label252: localStringBuilder.append(this.host);
        }
        label262: break label92;
        label264: if (this.path != null)
          localStringBuilder.append(encodePath(normalizePath(this.path), paramCharset));
      }
      label291: if (this.queryParams == null)
        break;
      localStringBuilder.append("?").append(encodeQuery(this.queryParams, paramCharset));
      break;
      label320: if (this.fragment != null)
