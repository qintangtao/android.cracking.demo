  ...
  implements Runnable
{
  ...
  public void run()
  {
    ...
    {
      Logg.e("Http Connect", "Connect error, taskEntity is null");
      this.errorMsg = new ErrorMsg();
    ...
    {
      Logg.e("Http Connect", "Connect error, URL is null");
      this.errorMsg = new ErrorMsg();
    ...
    try
    {
      Logg.e("Http Connect", "==============" + this.taskEntity.baseUrl);
 ...
 * Qualified Name:     com.hsg.sdk.common.http.TaskRunnable
