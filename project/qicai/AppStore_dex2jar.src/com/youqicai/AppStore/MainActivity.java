  ...
  implements TaskEntity.OnResultListener, DownLoadManager.MutiDownLoadListener
{
  ...
  Runnable updateRunnable = new Runnable()
  {
    public void run()
    {
      HttpUtil.AddTaskToQueueHead(BuildUrl.buildUpdateSelf("46", MainActivity.this.getPackageName(), DeviceInfo.getCid(MainActivity.this.mContext)), 1, new UpdateParser(), MainActivity.this);
    }
  };
