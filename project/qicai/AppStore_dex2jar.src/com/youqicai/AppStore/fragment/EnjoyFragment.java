  ...
  implements TaskEntity.OnResultListener, PullToRefreshBase.OnRefreshListener2<ListView>, InstallReceiver.AppInstallListener, RefreshListener
{
  ...
  public Handler mHandler = new Handler()
  {
    public void handleMessage(Message paramAnonymousMessage)
    {
      ...
      {
        return;
        EnjoyFragment.this.cardAdapter.setAll(EnjoyFragment.this.mDataList);
        EnjoyFragment.this.cardAdapter.notifyDataSetChanged();
        EnjoyFragment.this.setViewShowStatus(2);
        return;
        localList = (List)paramAnonymousMessage.obj;
      }
      while (localList == null);
      EnjoyFragment.this.mDataList.addAll(localList);
      EnjoyFragment.this.cardAdapter.setAll(EnjoyFragment.this.mDataList);
      EnjoyFragment.this.cardAdapter.notifyDataSetChanged();
      EnjoyFragment.this.setViewShowStatus(2);
    }
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    HttpUtil.AddTaskToQueueHead(BuildUrl.buildSmartRecommend(this.pageNo), 0, new BaseCardParser(), this);
  }
  ...
  {
    HttpUtil.AddTaskToQueueHead(BuildUrl.buildSmartRecommend(this.pageNo), 1, new BaseCardParser(), this);
  }
  ...
  public class CheckDownloadStatusThread extends Thread
  {
    ...
    public void run()
    {
      if ((EnjoyFragment.this.mDataList != null) && (EnjoyFragment.this.mDataList.size() > 0))
      {
        ArrayList localArrayList = new ArrayList();
        int i = 0;
        if (i < EnjoyFragment.this.mDataList.size())
        {
          AppInfoEntity localAppInfoEntity = ((CardEntity)EnjoyFragment.this.mDataList.get(i)).getSingleAppItem();
          ...
          while (true)
          {
            i++;
            break;
            List localList = ((CardEntity)EnjoyFragment.this.mDataList.get(i)).getAppItemList();
        ...
        localMessage.what = 0;
        EnjoyFragment.this.mHandler.sendMessage(localMessage);
      }
      super.run();
    }
  }
 ...
 * Qualified Name:     com.youqicai.AppStore.fragment.EnjoyFragment
