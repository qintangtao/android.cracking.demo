...
public class PersonalBoardFragment extends BaseFragment
  implements TaskEntity.OnResultListener, PullToRefreshBase.OnRefreshListener2, InstallReceiver.AppInstallListener, RefreshListener
{
  ...
  private static final String RANK_TYPE_PERSONAL = "personal";
  ...
  public Handler mHandler = new Handler()
  {
    public void handleMessage(Message paramAnonymousMessage)
    {
      ...
      {
        return;
        PersonalBoardFragment.this.appInfoAdapter.setAll(PersonalBoardFragment.this.mDataList);
        PersonalBoardFragment.this.appInfoAdapter.notifyDataSetChanged();
        PersonalBoardFragment.this.setViewShowStatus(2);
        return;
        localArrayList = (ArrayList)paramAnonymousMessage.obj;
      }
      while (localArrayList == null);
      PersonalBoardFragment.this.mDataList.addAll(localArrayList);
      for (int i = 0; i < PersonalBoardFragment.this.mDataList.size(); i++)
        ((AppInfoEntity)PersonalBoardFragment.this.mDataList.get(i)).setRank(i + 1);
      PersonalBoardFragment.this.appInfoAdapter.setAll(PersonalBoardFragment.this.mDataList);
      PersonalBoardFragment.this.appInfoAdapter.notifyDataSetChanged();
      PersonalBoardFragment.this.setViewShowStatus(2);
    }
  ...
  {
    PersonalBoardFragment localPersonalBoardFragment = new PersonalBoardFragment();
    Bundle localBundle = new Bundle();
    localBundle.putInt("position", paramInt);
    localPersonalBoardFragment.setArguments(localBundle);
    return localPersonalBoardFragment;
  }
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    HttpUtil.AddTaskToQueueHead(BuildUrl.buildBillBoard("personal", this.pageNo), 0, new UpdateParser(), this);
    setViewShowStatus(0);
  ...
  {
    HttpUtil.AddTaskToQueueHead(BuildUrl.buildBillBoard("personal", this.pageNo), 1, new UpdateParser(), this);
  }
  ...
  public class CheckDownloadStatusThread extends Thread
  {
    ...
    public void run()
    {
      if ((PersonalBoardFragment.this.mDataList != null) && (PersonalBoardFragment.this.mDataList.size() > 0))
      {
        ArrayList localArrayList = PersonalBoardFragment.this.mDataList;
        ApkManager.getInstance().checkDownloadStatus(localArrayList);
        Message localMessage = Message.obtain();
        localMessage.what = 0;
        PersonalBoardFragment.this.mHandler.sendMessage(localMessage);
      }
      super.run();
    }
  }
 ...
 * Qualified Name:     com.youqicai.AppStore.fragment.PersonalBoardFragment
