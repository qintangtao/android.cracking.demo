...
public class ViewDragHelper
{
  ...
  private boolean checkNewEdgeDrag(float paramFloat1, float paramFloat2, int paramInt1, int paramInt2)
  {
    ...
    if (((paramInt2 & this.mInitialEdgeTouched[paramInt1]) != paramInt2) || ((paramInt2 & this.mTrackingEdges) == 0) || ((paramInt2 & this.mEdgeDragsLocked[paramInt1]) == paramInt2) || ((paramInt2 & this.mEdgeDragsInProgress[paramInt1]) == paramInt2) || ((f1 <= this.mTouchSlop) && (f2 <= this.mTouchSlop)));
    do
    {
      return false;
  ...
  private void clearMotionHistory(int paramInt)
  {
    ...
    this.mInitialEdgeTouched[paramInt] = 0;
  ...
  private void ensureMotionHistorySizeForId(int paramInt)
  {
    if ((this.mInitialMotionX == null) || (this.mInitialMotionX.length <= paramInt))
    {
      ...
      if (this.mInitialMotionX != null)
      {
        ...
        System.arraycopy(this.mInitialEdgeTouched, 0, arrayOfInt1, 0, this.mInitialEdgeTouched.length);
      ...
      this.mInitialEdgeTouched = arrayOfInt1;
  ...
  private int getEdgeTouched(int paramInt1, int paramInt2)
  {
  ...
  private void saveInitialMotion(float paramFloat1, float paramFloat2, int paramInt)
  {
    ...
    this.mInitialEdgeTouched[paramInt] = getEdgeTouched((int)paramFloat1, (int)paramFloat2);
  ...
  {
    int i = this.mInitialEdgeTouched.length;
    for (int j = 0; j < i; j++)
  ...
  {
    return (isPointerDown(paramInt2)) && ((paramInt1 & this.mInitialEdgeTouched[paramInt2]) != 0);
  }
      ...
      do
      {
        ...
        do
        {
          ...
          do
          {
            ...
            i12 = this.mInitialEdgeTouched[i11];
          }
          ...
          i10 = this.mInitialEdgeTouched[i9];
        }
  ...
  public void setSensitivity(Context paramContext, float paramFloat)
  {
    ...
    this.mTouchSlop = ((int)(ViewConfiguration.get(paramContext).getScaledTouchSlop() * (1.0F / f)));
  }
  ...
  public boolean shouldInterceptTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (this.mDragState == 1)
    {
      ...
      int i4 = this.mInitialEdgeTouched[i3];
      if ((i4 & this.mTrackingEdges) != 0)
      {
        ...
        if (this.mDragState == 0)
        {
          int i2 = this.mInitialEdgeTouched[i1];
 ...
 * Qualified Name:     me.imid.swipebacklayout.lib.ViewDragHelper
