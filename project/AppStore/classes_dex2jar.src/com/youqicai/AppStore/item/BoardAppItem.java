...
public class BoardAppItem extends BaseItemView
  implements DownLoadManager.MutiDownLoadListener, View.OnClickListener
{
  ...
  public BoardAppItem(Context paramContext)
  {
    super(paramContext);
  }
  ...
  {
    this.contentView = this.mInflater.inflate(2130903080, null);
  ...
  public void setAppStatus(int paramInt)
  {
    ...
    case 0:
      ...
      this.viewHolder.state.setText(str8);
      setProgressVisible(8);
      return;
    case 2:
      ...
      String str6 = this.itemBean.getApkUrl();
      int[] arrayOfInt = new int[1];
      arrayOfInt[0] = Integer.parseInt(this.itemBean.getAppId());
  ...
  {
    if (Integer.parseInt(this.itemBean.getAppId()) == paramInt)
    {
  ...
  public void success(String paramString1, String paramString2, int paramInt)
  {
    ...
    this.viewHolder.state.setOnClickListener(new View.OnClickListener()
    {
      ...
      {
        ApkManager.getInstance().installApk(BoardAppItem.this.mContext, BoardAppItem.this.itemBean.getPackageName() + ".apk");
      }
    });
 ...
 * Qualified Name:     com.youqicai.AppStore.item.BoardAppItem
