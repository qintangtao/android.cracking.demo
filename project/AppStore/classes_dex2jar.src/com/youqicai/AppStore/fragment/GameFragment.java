  ...
  implements TaskEntity.OnResultListener, PullToRefreshBase.OnRefreshListener2<ListView>, InstallReceiver.AppInstallListener, RefreshListener
{
  ...
  public Handler mHandler = new Handler()
  {
    public void handleMessage(Message paramAnonymousMessage)
    {
      ...
      {
        return;
        GameFragment.this.cardAdapter.setAll(GameFragment.this.mDataList);
        GameFragment.this.cardAdapter.notifyDataSetChanged();
        GameFragment.this.setViewShowStatus(2);
        return;
        localList = (List)paramAnonymousMessage.obj;
      }
      while (localList == null);
      GameFragment.this.mDataList.addAll(localList);
      GameFragment.this.cardAdapter.setAll(GameFragment.this.mDataList);
      GameFragment.this.cardAdapter.notifyDataSetChanged();
      GameFragment.this.setViewShowStatus(2);
    }
  ...
  public void onActivityCreated(Bundle paramBundle)
  {
    ...
    this.pageNo = 1;
    HttpUtil.AddTaskToQueueHead(BuildUrl.buildGameList(this.pageNo), 0, new BaseCardParser(), this);
    setViewShowStatus(0);
  ...
  {
    HttpUtil.AddTaskToQueueHead(BuildUrl.buildGameList(this.pageNo), 1, new BaseCardParser(), this);
  }
  ...
  public class CheckDownloadStatusThread extends Thread
  {
    ...
    public void run()
    {
      if ((GameFragment.this.mDataList != null) && (GameFragment.this.mDataList.size() > 0))
      {
        ArrayList localArrayList = new ArrayList();
        int i = 0;
        if (i < GameFragment.this.mDataList.size())
        {
          AppInfoEntity localAppInfoEntity = ((CardEntity)GameFragment.this.mDataList.get(i)).getSingleAppItem();
          ...
          while (true)
          {
            i++;
            break;
            List localList = ((CardEntity)GameFragment.this.mDataList.get(i)).getAppItemList();
        ...
        localMessage.what = 0;
        GameFragment.this.mHandler.sendMessage(localMessage);
      }
      super.run();
    }
  }
 ...
 * Qualified Name:     com.youqicai.AppStore.fragment.GameFragment
