...
public class DBProvider
{
  ...
  private DBProvider(Context paramContext)
  {
    if (paramContext == null)
      return;
    this.context = paramContext.getApplicationContext();
    this.dbHelper = new DBHelper(this.context, "dtsdk.db");
  }

  public static DBProvider getDBProvider(Context paramContext)
  {
    try
    {
      if (provider == null)
        provider = new DBProvider(paramContext);
 ...
 * Qualified Name:     com.mycheering.data.DBProvider
