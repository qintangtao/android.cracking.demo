...
public class RunInstall extends UiAutomatorTestCase
{
  ...
  {
    return PhoneUtils.getInstance().Brand.equals("GiONEE");
  }
  ...
  private void loopclick()
  {
    ...
    String str = getParams().getString("pkg");
    if (str != null)
      System.out.println("waiting for install packangeName:" + str);
    while (true)
    {
      if ((this.isExitWithSettings) && (new UiObject(new UiSelector().packageName("com.android.settings")).exists()))
        return;
      uiSelectorClick();
      if ((str != null) && (UIHelper.GetAppVcode(str) > 0))
      {
        System.out.println("installed packangeName:" + str);
        return;
      }
      if (System.currentTimeMillis() - startTime > 1000 * startTtage)
        SystemClock.sleep(1000 * afterFrequency);
      while (0 != 0)
      {
        return;
  ...
  {
    String str = PhoneUtils.getInstance().Model;
  ...
  private void writetoSD(String paramString)
  {
    ...
    //   10: astore_2
    //   11: aload_2
    //   12: invokevirtual 297	java/io/File:exists	()Z
    //   15: ifne +8 -> 23
    //   18: aload_2
    //   19: invokevirtual 393	java/io/File:mkdirs	()Z
    //   22: pop
    //   23: new 290	java/io/File
    //   26: dup
    //   27: ldc_w 395
    //   30: invokespecial 294	java/io/File:<init>	(Ljava/lang/String;)V
    //   33: astore_3
    //   34: aload_3
    //   35: invokevirtual 297	java/io/File:exists	()Z
    //   38: ifne +8 -> 46
    //   41: aload_3
    //   42: invokevirtual 398	java/io/File:createNewFile	()Z
    //   45: pop
    //   46: aconst_null
    //   47: astore 4
    //   49: new 400	java/io/FileWriter
    //   52: dup
    //   53: ldc_w 395
    //   56: iconst_1
    //   57: invokespecial 403	java/io/FileWriter:<init>	(Ljava/lang/String;Z)V
    //   60: astore 5
    //   62: aload 5
    //   64: aload_1
    //   65: invokevirtual 406	java/io/FileWriter:write	(Ljava/lang/String;)V
    //   68: aload 5
    //   70: ifnull +8 -> 78
    //   73: aload 5
    //   75: invokevirtual 407	java/io/FileWriter:close	()V
    //   78: return
    //   79: astore 11
    //   81: aload 11
    //   83: invokevirtual 408	java/io/IOException:printStackTrace	()V
    //   86: goto -40 -> 46
    //   89: astore 10
    //   91: aload 10
    //   93: invokevirtual 408	java/io/IOException:printStackTrace	()V
    //   96: return
    //   97: astore 6
    //   99: aload 6
    //   101: invokevirtual 408	java/io/IOException:printStackTrace	()V
    //   104: aload 4
    //   106: ifnull -28 -> 78
    //   109: aload 4
    //   111: invokevirtual 407	java/io/FileWriter:close	()V
    //   114: return
    //   115: astore 9
    //   117: aload 9
    //   119: invokevirtual 408	java/io/IOException:printStackTrace	()V
    //   122: return
    //   123: astore 7
    //   125: aload 4
    //   127: ifnull +8 -> 135
    //   130: aload 4
    //   132: invokevirtual 407	java/io/FileWriter:close	()V
    //   135: aload 7
    //   137: athrow
    //   138: astore 8
    //   140: aload 8
    //   142: invokevirtual 408	java/io/IOException:printStackTrace	()V
    //   145: goto -10 -> 135
    //   148: astore 7
    //   150: aload 5
    //   152: astore 4
